        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("NotoSans") action [gui.SetPreference("font", "gui/fonts/NotoSans-Regular.ttf"), SetVariable("typeface", "NotoSans")]  alt "Change to NotoSans" # [gui.SetPreference("font", "gui/fonts/NotoSans-Regular.ttf"), gui.SetPreference("dialogue_spacing", 3), SetVariable("typeface", "NotoSans")]  alt "Change to NotoSans"

                    textbutton _("DejaVuSans") action [gui.SetPreference("font", "DejaVuSans.ttf"), SetVariable("typeface", "DejaVuSans")] alt "Change to DejaVuSans" # [gui.SetPreference("font", "DejaVuSans.ttf"), gui.SetPreference("dialogue_spacing", 3), SetVariable("typeface", "DejaVuSans")]  alt "Change to DejaVuSans"

                    textbutton _("OpenDyslexic") action [gui.SetPreference("font", "gui/fonts/OpenDyslexic-VN.otf"), SetVariable("typeface", "OpenDyslexic")]  alt "Change to OpenDyslexic" # [gui.SetPreference("font", "gui/fonts/OpenDyslexic-VN.otf"), gui.SetPreference("dialogue_spacing", -4), gui.SetPreference("size", 35), gui.SetPreference("phone_size", 30), SetVariable("typeface", "OpenDyslexic")] alt "Change to OpenDyslexic"
                    ...
                    ## to be all selected, causing players some confusion.
                    ## TODO: Find out a way to prevent issue above.
                ...
                vbox:
                    ...
                    if typeface == "OpenDyslexic":
                        ...
                        textbutton _("Taller") action gui.SetPreference("dialogue_spacing", -2) alt "Change to Large Size Text"
                        textbutton _("Regular") action gui.SetPreference("dialogue_spacing", -4) alt "Change to Regular Size Text"

                    else:

                        textbutton _("Taller") action gui.SetPreference("dialogue_spacing", 4) alt "Change to Large Size Text"
                        textbutton _("Regular") action gui.SetPreference("dialogue_spacing", 2) alt "Change to Regular Size Text"
            ...
            hbox:
                ...
                vbox:
                    ...
                    if renpy.variant("pc"):
                        ...
                        textbutton _("Black") action gui.SetPreference("ADVtextbox", "gui/textbox_1.png") alt "Change to Black Textbox"
                        textbutton _("White") action gui.SetPreference("ADVtextbox", "gui/textbox_2.png") alt "Change to White Textbox"
                     ...
                     ## NOTE: At the moment, the NVL textbox option is not being used due
                     ## to an issue with updating both the textbox image and the NVL entry
                     ## if a player switches this preference during NVL mode.
                    ## TODO: Find out a way to prevent issue above.
                ...
                vbox:
                    ...
                    textbutton _("Song Titles") action ToggleField(persistent,"audio_cues",true_value=True,false_value=False) alt "Toggle Song Titles"
                    textbutton _("SFX Titles") action ToggleVariable("persistent.sound_captions") alt "Toggle Sound Captions"
...
style nvl_window:
    ...
    background gui.preference("NVLtextbox", "gui/nvl_1.png") #"gui/nvl.png"
...
## Extras screens ###########################################
##
## A screen that includes Image Galleries, Music Room, Replay Room, and Dev Notes.
...
define gui.dev_notes = _p("""Hello, this is BáiYù of tofurocks here. I want to thank
    ...
    \n
    Unfortunately, as of this writing, there were a few bumps in the road with some of the features I wanted to add. Different fonts have different line_spacing properties, so in trying to automatically adjust it for each typeface, it caused bugs in the way the radio buttons were being shown. I'll be working on finding a fix for that, but for now I hope this update helps.
    \n
